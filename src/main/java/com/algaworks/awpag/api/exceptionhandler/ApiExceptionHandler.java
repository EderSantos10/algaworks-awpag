...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler{
	...
	private final MessageSource messageSoucer;
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		var fields =ex.getBindingResult().getAllErrors().stream().collect(Collectors.toMap(error -> ((FieldError) error).getField(), error -> messageSoucer.getMessage(error, LocaleContextHolder.getLocale())));
	...
	public ProblemDetail handleDataIntegrityiolation(DataIntegrityViolationException e) {
